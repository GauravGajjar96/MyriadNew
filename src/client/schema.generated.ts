...
/** Allowed Content Types of the PortfolioCategory taxonomy. */
export enum ContentTypesOfPortfolioCategoryEnum {
  /** The Type of Content object */
  PORTFOLIO = "PORTFOLIO",
}
...
/** Input for the createPortfolioCategory mutation */
export interface CreatePortfolioCategoryInput {
  /** The slug that the portfolio_category will be an alias of */
  aliasOf?: InputMaybe<Scalars["String"]>;
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars["String"]>;
  /** The description of the portfolio_category object */
  description?: InputMaybe<Scalars["String"]>;
  /** The name of the portfolio_category object to mutate */
  name: Scalars["String"];
  /** If this argument exists then the slug will be checked to see if it is not an existing valid term. If that check succeeds (it is not a valid term), then it is added and the term id is given. If it fails, then a check is made to whether the taxonomy is hierarchical and the parent argument is not empty. If the second check succeeds, the term will be inserted and the term id will be given. If the slug argument is empty, then it will be calculated from the term name. */
  slug?: InputMaybe<Scalars["String"]>;
}
...
export interface CreatePortfolioInput {
  ...
  /** The password used to protect the content of the object */
  password?: InputMaybe<Scalars["String"]>;
  /** Set connections between the Portfolio and PortfolioCategories */
  portfolioCategories?: InputMaybe<PortfolioPortfolioCategoriesInput>;
  /** The slug of the object */
  slug?: InputMaybe<Scalars["String"]>;
  /** The status of the object */
  status?: InputMaybe<PostStatusEnum>;
...
/** Input for the deletePortfolioCategory mutation */
export interface DeletePortfolioCategoryInput {
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars["String"]>;
  /** The ID of the PortfolioCategory to delete */
  id: Scalars["ID"];
}
...
export enum MenuLocationEnum {
  ...
  FOOTER = "FOOTER",
  /** Put the menu in the our-services location */
...
/** The Type of Identifier used to fetch a single resource. Default is ID. */
export enum PortfolioCategoryIdType {
  /** The Database ID for the node */
  DATABASE_ID = "DATABASE_ID",
  /** The hashed Global ID */
  ID = "ID",
...
/** Arguments for filtering the PortfolioCategoryToContentNodeConnection connection */
export interface PortfolioCategoryToContentNodeConnectionWhereArgs {
  /** The Types of content to filter */
  contentTypes?: InputMaybe<
    Array<InputMaybe<ContentTypesOfPortfolioCategoryEnum>>
  >;
  /** Filter the connection based on dates */
  dateQuery?: InputMaybe<DateQueryInput>;
  /** True for objects with passwords; False for objects without passwords; null for all objects with or without passwords */
...
/** Set relationships between the Portfolio to PortfolioCategories */
export interface PortfolioPortfolioCategoriesInput {
  /** If true, this will append the PortfolioCategory to existing related PortfolioCategories. If false, this will replace existing relationships. Default true. */
  append?: InputMaybe<Scalars["Boolean"]>;
  /** The input list of items to set. */
  nodes?: InputMaybe<Array<InputMaybe<PortfolioPortfolioCategoriesNodeInput>>>;
}

/** List of PortfolioCategories to connect the Portfolio to. If an ID is set, it will be used to create the connection. If not, it will look for a slug. If neither are valid existing terms, and the site is configured to allow terms to be created during post mutations, a term will be created using the Name if it exists in the input, then fallback to the slug if it exists. */
export interface PortfolioPortfolioCategoriesNodeInput {
  /** The description of the PortfolioCategory. This field is used to set a description of the PortfolioCategory if a new one is created during the mutation. */
  description?: InputMaybe<Scalars["String"]>;
  /** The ID of the PortfolioCategory. If present, this will be used to connect to the Portfolio. If no existing PortfolioCategory exists with this ID, no connection will be made. */
  id?: InputMaybe<Scalars["ID"]>;
  /** The name of the PortfolioCategory. This field is used to create a new term, if term creation is enabled in nested mutations, and if one does not already exist with the provided slug or ID or if a slug or ID is not provided. If no name is included and a term is created, the creation will fallback to the slug field. */
  name?: InputMaybe<Scalars["String"]>;
  /** The slug of the PortfolioCategory. If no ID is present, this field will be used to make a connection. If no existing term exists with this slug, this field will be used as a fallback to the Name field when creating a new term to connect to, if term creation is enabled as a nested mutation. */
  slug?: InputMaybe<Scalars["String"]>;
}

/** Arguments for filtering the PortfolioToPortfolioCategoryConnection connection */
export interface PortfolioToPortfolioCategoryConnectionWhereArgs {
  /** Unique cache key to be produced when this query is stored in an object cache. Default is 'core'. */
  cacheDomain?: InputMaybe<Scalars["String"]>;
  /** Term ID to retrieve child terms of. If multiple taxonomies are passed, $child_of is ignored. Default 0. */
  childOf?: InputMaybe<Scalars["Int"]>;
...
/** Arguments for filtering the PortfolioToTermNodeConnection connection */
export interface PortfolioToTermNodeConnectionWhereArgs {
  /** Unique cache key to be produced when this query is stored in an object cache. Default is 'core'. */
  cacheDomain?: InputMaybe<Scalars["String"]>;
  /** Term ID to retrieve child terms of. If multiple taxonomies are passed, $child_of is ignored. Default 0. */
  childOf?: InputMaybe<Scalars["Int"]>;
...
/** Arguments for filtering the RootQueryToPortfolioCategoryConnection connection */
export interface RootQueryToPortfolioCategoryConnectionWhereArgs {
  /** Unique cache key to be produced when this query is stored in an object cache. Default is 'core'. */
  cacheDomain?: InputMaybe<Scalars["String"]>;
  /** Term ID to retrieve child terms of. If multiple taxonomies are passed, $child_of is ignored. Default 0. */
  childOf?: InputMaybe<Scalars["Int"]>;
...
export enum TaxonomyEnum {
  ...
  CATEGORY = "CATEGORY",
  /** Taxonomy enum portfolio_category */
...
/** Input for the UpdatePortfolioCategory mutation */
export interface UpdatePortfolioCategoryInput {
  ...
  /** The description of the portfolio_category object */
  description?: InputMaybe<Scalars["String"]>;
  /** The ID of the PortfolioCategory object to update */
  id: Scalars["ID"];
  /** The name of the portfolio_category object to mutate */
  name?: InputMaybe<Scalars["String"]>;
  /** If this argument exists then the slug will be checked to see if it is not an existing valid term. If that check succeeds (it is not a valid term), then it is added and the term id is given. If it fails, then a check is made to whether the taxonomy is hierarchical and the parent argument is not empty. If the second check succeeds, the term will be inserted and the term id will be given. If the slug argument is empty, then it will be calculated from the term name. */
...
export const scalarsEnumsHash: import("gqty").ScalarsEnumsHash = {
  ...
  ContentTypesOfPortfolioCategoryEnum: true,
...
export const generatedSchema = {
  ...
  CreatePortfolioCategoryPayload: {
    __typename: { __type: "String!" },
    clientMutationId: { __type: "String" },
    portfolioCategory: { __type: "PortfolioCategory" },
  },
  CreatePortfolioInput: {
    ...
    menuOrder: { __type: "Int" },
    password: { __type: "String" },
    portfolioCategories: { __type: "PortfolioPortfolioCategoriesInput" },
    slug: { __type: "String" },
    status: { __type: "PostStatusEnum" },
    title: { __type: "String" },
  },
  ...
  DeletePortfolioCategoryInput: {
    clientMutationId: { __type: "String" },
    id: { __type: "ID!" },
  },
  DeletePortfolioCategoryPayload: {
    __typename: { __type: "String!" },
    clientMutationId: { __type: "String" },
    deletedId: { __type: "ID" },
    portfolioCategory: { __type: "PortfolioCategory" },
  ...
  Page: {
    ...
    featuredImageDatabaseId: { __type: "Int" },
    featuredImageId: { __type: "ID" },
    fieldLayoutOptions: { __type: "Page_Fieldlayoutoptions" },
    guid: { __type: "String" },
    id: { __type: "ID!" },
    isContentNode: { __type: "Boolean!" },
    isFrontPage: { __type: "Boolean!" },
  ...
  Page_Fieldlayoutoptions: {
    __typename: { __type: "String!" },
    fieldGroupName: { __type: "String" },
    flexibleLayouts: { __type: "[Page_Fieldlayoutoptions_FlexibleLayouts]" },
  },
  Page_Fieldlayoutoptions_FlexibleLayouts: {
    __typename: { __type: "String!" },
    $on: { __type: "$Page_Fieldlayoutoptions_FlexibleLayouts!" },
  },
  ...
  Page_Fieldlayoutoptions_FlexibleLayouts_CareersSection: {
    ...
    positionsList: {
      __type:
        "[Page_Fieldlayoutoptions_FlexibleLayouts_CareersSection_positionsList]",
    },
  },
  Page_Fieldlayoutoptions_FlexibleLayouts_CareersSection_positionsList: {
    __typename: { __type: "String!" },
  ...
  Page_Fieldlayoutoptions_FlexibleLayouts_FullWidthCta: {
    __typename: { __type: "String!" },
    buttons: {
      __type: "[Page_Fieldlayoutoptions_FlexibleLayouts_FullWidthCta_buttons]",
    },
    description: { __type: "String" },
    fieldGroupName: { __type: "String" },
    heading: { __type: "String" },
  ...
  Page_Fieldlayoutoptions_FlexibleLayouts_FullWidthCta_buttons: {
    __typename: { __type: "String!" },
  ...
  Page_Fieldlayoutoptions_FlexibleLayouts_HeroSection: {
    __typename: { __type: "String!" },
    buttons: {
      __type: "[Page_Fieldlayoutoptions_FlexibleLayouts_HeroSection_buttons]",
    },
    description: { __type: "String" },
    fieldGroupName: { __type: "String" },
    heading: { __type: "String" },
  ...
  Page_Fieldlayoutoptions_FlexibleLayouts_HeroSection_buttons: {
    __typename: { __type: "String!" },
    fieldGroupName: { __type: "String" },
    link: { __type: "AcfLink" },
  },
  ...
  Page_Fieldlayoutoptions_FlexibleLayouts_IntroSection: {
    ...
    introPoints: {
      __type:
        "[Page_Fieldlayoutoptions_FlexibleLayouts_IntroSection_introPoints]",
    },
  ...
  Page_Fieldlayoutoptions_FlexibleLayouts_OffersSection: {
    ...
    manageSpacing: { __type: "String" },
    offers: {
      __type: "[Page_Fieldlayoutoptions_FlexibleLayouts_OffersSection_offers]",
    },
  },
  ...
  Portfolio: {
    ...
    modifiedGmt: { __type: "String" },
    portfolioCategories: {
      __type: "PortfolioToPortfolioCategoryConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
        last: "Int",
        where: "PortfolioToPortfolioCategoryConnectionWhereArgs",
      },
    },
    ...
    templates: { __type: "[String]" },
    terms: {
      __type: "PortfolioToTermNodeConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
        last: "Int",
        where: "PortfolioToTermNodeConnectionWhereArgs",
      },
    },
    title: {
      __type: "String",
  ...
  PortfolioCategory: {
    ...
    conditionalTags: { __type: "ConditionalTags" },
    contentNodes: {
      __type: "PortfolioCategoryToContentNodeConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
        last: "Int",
        where: "PortfolioCategoryToContentNodeConnectionWhereArgs",
      },
    },
    count: { __type: "Int" },
    databaseId: { __type: "Int!" },
    ...
    name: { __type: "String" },
    portfolio: {
      __type: "PortfolioCategoryToPortfolioConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
    ...
    portfolioCategoryId: { __type: "Int" },
    slug: { __type: "String" },
  ...
  PortfolioCategoryToContentNodeConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[PortfolioCategoryToContentNodeConnectionEdge]" },
    nodes: { __type: "[ContentNode]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  ...
  PortfolioCategoryToContentNodeConnectionWhereArgs: {
    contentTypes: { __type: "[ContentTypesOfPortfolioCategoryEnum]" },
    dateQuery: { __type: "DateQueryInput" },
    hasPassword: { __type: "Boolean" },
    id: { __type: "Int" },
    in: { __type: "[ID]" },
  ...
  PortfolioCategoryToPortfolioConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[PortfolioCategoryToPortfolioConnectionEdge]" },
  ...
  PortfolioCategoryToPortfolioConnectionWhereArgs: {
    dateQuery: { __type: "DateQueryInput" },
    hasPassword: { __type: "Boolean" },
    id: { __type: "Int" },
    in: { __type: "[ID]" },
  ...
  PortfolioPortfolioCategoriesInput: {
    ...
    nodes: { __type: "[PortfolioPortfolioCategoriesNodeInput]" },
  },
  PortfolioPortfolioCategoriesNodeInput: {
    description: { __type: "String" },
    id: { __type: "ID" },
    name: { __type: "String" },
    slug: { __type: "String" },
  ...
  PortfolioToPortfolioCategoryConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[PortfolioToPortfolioCategoryConnectionEdge]" },
    nodes: { __type: "[PortfolioCategory]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  PortfolioToPortfolioCategoryConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "PortfolioCategory" },
  },
  PortfolioToPortfolioCategoryConnectionWhereArgs: {
    cacheDomain: { __type: "String" },
    childOf: { __type: "Int" },
    childless: { __type: "Boolean" },
    descriptionLike: { __type: "String" },
  ...
  PortfolioToTermNodeConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[PortfolioToTermNodeConnectionEdge]" },
  ...
  PortfolioToTermNodeConnectionWhereArgs: {
    cacheDomain: { __type: "String" },
    childOf: { __type: "Int" },
    childless: { __type: "Boolean" },
    descriptionLike: { __type: "String" },
  ...
  RootQueryToPortfolioCategoryConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[RootQueryToPortfolioCategoryConnectionEdge]" },
    nodes: { __type: "[PortfolioCategory]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  RootQueryToPortfolioCategoryConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "PortfolioCategory" },
  },
  RootQueryToPortfolioCategoryConnectionWhereArgs: {
    cacheDomain: { __type: "String" },
    childOf: { __type: "Int" },
    childless: { __type: "Boolean" },
    descriptionLike: { __type: "String" },
  ...
  ThemeGeneralSettings: {
    ...
    generalThemeSettings: {
      __type: "ThemeGeneralSettings_Generalthemesettings",
    },
  ...
  ThemeGeneralSettings_Generalthemesettings: {
    ...
    socialMediaList: {
      __type: "[ThemeGeneralSettings_Generalthemesettings_socialMediaList]",
    },
  },
  ThemeGeneralSettings_Generalthemesettings_socialMediaList: {
    __typename: { __type: "String!" },
    fieldGroupName: { __type: "String" },
    socialIcon: { __type: "String" },
    socialLink: { __type: "String" },
    socialName: { __type: "String" },
  },
  ...
  UpdatePortfolioCategoryPayload: {
    __typename: { __type: "String!" },
    clientMutationId: { __type: "String" },
    portfolioCategory: { __type: "PortfolioCategory" },
  },
  ...
  mutation: {
    ...
    createPortfolioCategory: {
      __type: "CreatePortfolioCategoryPayload",
      __args: { input: "CreatePortfolioCategoryInput!" },
    },
    createPost: {
    ...
    deletePortfolioCategory: {
      __type: "DeletePortfolioCategoryPayload",
      __args: { input: "DeletePortfolioCategoryInput!" },
    },
    deletePost: {
    ...
    updatePortfolioCategory: {
      __type: "UpdatePortfolioCategoryPayload",
      __args: { input: "UpdatePortfolioCategoryInput!" },
    },
    updatePost: {
  ...
  query: {
    ...
    portfolioCategories: {
      __type: "RootQueryToPortfolioCategoryConnection",
      __args: {
        after: "String",
        before: "String",
        first: "Int",
        last: "Int",
        where: "RootQueryToPortfolioCategoryConnectionWhereArgs",
      },
    },
    portfolioCategory: {
      __type: "PortfolioCategory",
      __args: { id: "ID!", idType: "PortfolioCategoryIdType" },
    },
    post: {
      __type: "Post",
  ...
  [SchemaUnionsKey]: {
    ...
    TermNode: ["Category", "PortfolioCategory", "PostFormat", "Tag"],
    UniformResourceIdentifiable: [
      "Category",
      "ContentType",
      "MediaItem",
...
/**
 * The payload for the createPortfolioCategory mutation
 */
export interface CreatePortfolioCategoryPayload {
  __typename?: "CreatePortfolioCategoryPayload";
  /**
   * If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions.
   */
  clientMutationId?: Maybe<ScalarsEnums["String"]>;
  /**
   * The created portfolio_category
   */
...
/**
 * The payload for the deletePortfolioCategory mutation
 */
export interface DeletePortfolioCategoryPayload {
  __typename?: "DeletePortfolioCategoryPayload";
  /**
   * If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions.
   */
  clientMutationId?: Maybe<ScalarsEnums["String"]>;
...
export interface Page {
   ...
   */
  fieldLayoutOptions?: Maybe<Page_Fieldlayoutoptions>;
  /**
   * The global unique identifier for this post. This currently matches the value stored in WP_Post-&gt;guid and the guid column in the &quot;post_objects&quot; database table.
   */
  guid?: Maybe<ScalarsEnums["String"]>;
 ...
 * Field Group
 */
export interface Page_Fieldlayoutoptions {
  __typename?: "Page_Fieldlayoutoptions";
  /**
   * The name of the ACF Field Group
   */
  fieldGroupName?: Maybe<ScalarsEnums["String"]>;
  flexibleLayouts?: Maybe<
    Array<Maybe<Page_Fieldlayoutoptions_FlexibleLayouts>>
  >;
}

export interface Page_Fieldlayoutoptions_FlexibleLayouts {
  __typename?:
    | "Page_Fieldlayoutoptions_FlexibleLayouts_AboutInfo"
    | "Page_Fieldlayoutoptions_FlexibleLayouts_CareersSection"
    | "Page_Fieldlayoutoptions_FlexibleLayouts_ChooseUsSection"
 ...
 */
export interface Page_Fieldlayoutoptions_FlexibleLayouts_AboutInfo {
  __typename?: "Page_Fieldlayoutoptions_FlexibleLayouts_AboutInfo";
 ...
 * Group within the flex field
 */
export interface Page_Fieldlayoutoptions_FlexibleLayouts_CareersSection {
  __typename?: "Page_Fieldlayoutoptions_FlexibleLayouts_CareersSection";
  /**
   * The name of the ACF Field Group
   */
  fieldGroupName?: Maybe<ScalarsEnums["String"]>;
  positionsList?: Maybe<
    Array<
      Maybe<Page_Fieldlayoutoptions_FlexibleLayouts_CareersSection_positionsList>
    >
  >;
}
 ...
 * Field Group
 */
export interface Page_Fieldlayoutoptions_FlexibleLayouts_CareersSection_positionsList {
  __typename?: "Page_Fieldlayoutoptions_FlexibleLayouts_CareersSection_positionsList";
  /**
   * The name of the ACF Field Group
   */
  fieldGroupName?: Maybe<ScalarsEnums["String"]>;
 ...
 * Group within the flex field
 */
export interface Page_Fieldlayoutoptions_FlexibleLayouts_ChooseUsSection {
  __typename?: "Page_Fieldlayoutoptions_FlexibleLayouts_ChooseUsSection";
  chooseUsPoints?: Maybe<
    Array<
      Maybe<Page_Fieldlayoutoptions_FlexibleLayouts_ChooseUsSection_chooseUsPoints>
    >
  >;
  /**
   * The name of the ACF Field Group
 ...
 * Field Group
 */
export interface Page_Fieldlayoutoptions_FlexibleLayouts_ChooseUsSection_chooseUsPoints {
  __typename?: "Page_Fieldlayoutoptions_FlexibleLayouts_ChooseUsSection_chooseUsPoints";
 ...
 * Group within the flex field
 */
export interface Page_Fieldlayoutoptions_FlexibleLayouts_ContactSection {
  __typename?: "Page_Fieldlayoutoptions_FlexibleLayouts_ContactSection";
  description?: Maybe<ScalarsEnums["String"]>;
  /**
   * The name of the ACF Field Group
   */
 ...
 * Group within the flex field
 */
export interface Page_Fieldlayoutoptions_FlexibleLayouts_ContentWithSidebar {
  __typename?: "Page_Fieldlayoutoptions_FlexibleLayouts_ContentWithSidebar";
  blockContent?: Maybe<ScalarsEnums["String"]>;
  /**
   * The name of the ACF Field Group
   */
 ...
 * Group within the flex field
 */
export interface Page_Fieldlayoutoptions_FlexibleLayouts_Expertise {
  __typename?: "Page_Fieldlayoutoptions_FlexibleLayouts_Expertise";
  ...
  expertiseList?: Maybe<
    Array<
      Maybe<Page_Fieldlayoutoptions_FlexibleLayouts_Expertise_expertiseList>
    >
  >;
  /**
   * The name of the ACF Field Group
 ...
 * Field Group
 */
export interface Page_Fieldlayoutoptions_FlexibleLayouts_Expertise_expertiseList {
  __typename?: "Page_Fieldlayoutoptions_FlexibleLayouts_Expertise_expertiseList";
  /**
   * The name of the ACF Field Group
   */
  fieldGroupName?: Maybe<ScalarsEnums["String"]>;
 ...
 * Group within the flex field
 */
export interface Page_Fieldlayoutoptions_FlexibleLayouts_FullWidthCta {
  __typename?: "Page_Fieldlayoutoptions_FlexibleLayouts_FullWidthCta";
  buttons?: Maybe<
    Array<Maybe<Page_Fieldlayoutoptions_FlexibleLayouts_FullWidthCta_buttons>>
  >;
  description?: Maybe<ScalarsEnums["String"]>;
  /**
   * The name of the ACF Field Group
 ...
 * Field Group
 */
export interface Page_Fieldlayoutoptions_FlexibleLayouts_FullWidthCta_buttons {
  __typename?: "Page_Fieldlayoutoptions_FlexibleLayouts_FullWidthCta_buttons";
 ...
 * Group within the flex field
 */
export interface Page_Fieldlayoutoptions_FlexibleLayouts_HeroSection {
  __typename?: "Page_Fieldlayoutoptions_FlexibleLayouts_HeroSection";
  buttons?: Maybe<
    Array<Maybe<Page_Fieldlayoutoptions_FlexibleLayouts_HeroSection_buttons>>
  >;
  description?: Maybe<ScalarsEnums["String"]>;
  /**
   * The name of the ACF Field Group
 ...
 * Field Group
 */
export interface Page_Fieldlayoutoptions_FlexibleLayouts_HeroSection_buttons {
  __typename?: "Page_Fieldlayoutoptions_FlexibleLayouts_HeroSection_buttons";
  /**
   * The name of the ACF Field Group
   */
  fieldGroupName?: Maybe<ScalarsEnums["String"]>;
 ...
 * Group within the flex field
 */
export interface Page_Fieldlayoutoptions_FlexibleLayouts_InnerBannerSection {
  __typename?: "Page_Fieldlayoutoptions_FlexibleLayouts_InnerBannerSection";
  buttons?: Maybe<
    Array<
      Maybe<Page_Fieldlayoutoptions_FlexibleLayouts_InnerBannerSection_buttons>
    >
  >;
  description?: Maybe<ScalarsEnums["String"]>;
  /**
 ...
 * Field Group
 */
export interface Page_Fieldlayoutoptions_FlexibleLayouts_InnerBannerSection_buttons {
  __typename?: "Page_Fieldlayoutoptions_FlexibleLayouts_InnerBannerSection_buttons";
  /**
   * The name of the ACF Field Group
   */
  fieldGroupName?: Maybe<ScalarsEnums["String"]>;
 ...
 * Group within the flex field
 */
export interface Page_Fieldlayoutoptions_FlexibleLayouts_IntroSection {
  __typename?: "Page_Fieldlayoutoptions_FlexibleLayouts_IntroSection";
  description?: Maybe<ScalarsEnums["String"]>;
  /**
   * The name of the ACF Field Group
   */
  ...
  introPoints?: Maybe<
    Array<
      Maybe<Page_Fieldlayoutoptions_FlexibleLayouts_IntroSection_introPoints>
    >
  >;
 ...
 * Field Group
 */
export interface Page_Fieldlayoutoptions_FlexibleLayouts_IntroSection_introPoints {
  __typename?: "Page_Fieldlayoutoptions_FlexibleLayouts_IntroSection_introPoints";
  /**
   * The name of the ACF Field Group
   */
  fieldGroupName?: Maybe<ScalarsEnums["String"]>;
 ...
 * Group within the flex field
 */
export interface Page_Fieldlayoutoptions_FlexibleLayouts_OffersSection {
  __typename?: "Page_Fieldlayoutoptions_FlexibleLayouts_OffersSection";
  /**
   * The name of the ACF Field Group
   */
  fieldGroupName?: Maybe<ScalarsEnums["String"]>;
  ...
  manageSpacing?: Maybe<ScalarsEnums["String"]>;
  offers?: Maybe<
    Array<Maybe<Page_Fieldlayoutoptions_FlexibleLayouts_OffersSection_offers>>
  >;
}
 ...
 * Field Group
 */
export interface Page_Fieldlayoutoptions_FlexibleLayouts_OffersSection_offers {
  __typename?: "Page_Fieldlayoutoptions_FlexibleLayouts_OffersSection_offers";
  content?: Maybe<ScalarsEnums["String"]>;
  /**
   * The name of the ACF Field Group
   */
 ...
 * Group within the flex field
 */
export interface Page_Fieldlayoutoptions_FlexibleLayouts_Portfolio {
  __typename?: "Page_Fieldlayoutoptions_FlexibleLayouts_Portfolio";
  description?: Maybe<ScalarsEnums["String"]>;
  /**
   * The name of the ACF Field Group
   */
  ...
  portfolioList?: Maybe<
    Array<
      Maybe<Page_Fieldlayoutoptions_FlexibleLayouts_Portfolio_PortfolioList>
    >
  >;
}

export interface Page_Fieldlayoutoptions_FlexibleLayouts_Portfolio_PortfolioList {
  __typename?: "Portfolio";
  $on: $Page_Fieldlayoutoptions_FlexibleLayouts_Portfolio_PortfolioList;
}
 ...
 * Group within the flex field
 */
export interface Page_Fieldlayoutoptions_FlexibleLayouts_ServicesSection {
  __typename?: "Page_Fieldlayoutoptions_FlexibleLayouts_ServicesSection";
  description?: Maybe<ScalarsEnums["String"]>;
  /**
   * The name of the ACF Field Group
   */
  ...
  services?: Maybe<
    Array<
      Maybe<Page_Fieldlayoutoptions_FlexibleLayouts_ServicesSection_services>
    >
  >;
}
 ...
 * Field Group
 */
export interface Page_Fieldlayoutoptions_FlexibleLayouts_ServicesSection_services {
  __typename?: "Page_Fieldlayoutoptions_FlexibleLayouts_ServicesSection_services";
  content?: Maybe<ScalarsEnums["String"]>;
  /**
   * The name of the ACF Field Group
   */
...
export interface Portfolio {
  ...
  modifiedGmt?: Maybe<ScalarsEnums["String"]>;
  /**
   * Connection between the Portfolio type and the PortfolioCategory type
   */
  portfolioCategories: (args?: {
    /**
     * Cursor used along with the "first" argument to reference where in the dataset to get data
     */
    after?: Maybe<Scalars["String"]>;
     ...
     * Arguments for filtering the connection
     */
    where?: Maybe<PortfolioToPortfolioCategoryConnectionWhereArgs>;
  }) => Maybe<PortfolioToPortfolioCategoryConnection>;
  /**
   * The id field matches the WP_Post-&gt;ID field.
   * @deprecated Deprecated in favor of the databaseId field
   */
  ...
  terms: (args?: {
     ...
     * Arguments for filtering the connection
     */
    where?: Maybe<PortfolioToTermNodeConnectionWhereArgs>;
  }) => Maybe<PortfolioToTermNodeConnection>;
  /**
   * The title of the post. This is currently just the raw title. An amendment to support rendered title needs to be made.
   */
  title: (args?: {
...
export interface PortfolioCategory {
  ...
  conditionalTags?: Maybe<ConditionalTags>;
  /**
   * Connection between the PortfolioCategory type and the ContentNode type
   */
  contentNodes: (args?: {
    /**
     * Cursor used along with the "first" argument to reference where in the dataset to get data
     ...
     * Arguments for filtering the connection
     */
    where?: Maybe<PortfolioCategoryToContentNodeConnectionWhereArgs>;
  }) => Maybe<PortfolioCategoryToContentNodeConnection>;
  /**
   * The number of objects connected to the object
   */
  count?: Maybe<ScalarsEnums["Int"]>;
  ...
  name?: Maybe<ScalarsEnums["String"]>;
  /**
   * Connection between the PortfolioCategory type and the Portfolio type
   */
  portfolio: (args?: {
    /**
     * Cursor used along with the "first" argument to reference where in the dataset to get data
   ...
   * @deprecated Deprecated in favor of databaseId
   */
  portfolioCategoryId?: Maybe<ScalarsEnums["Int"]>;
  /**
   * An alphanumeric identifier for the object unique to its type.
   */
  slug?: Maybe<ScalarsEnums["String"]>;
  /**
   * Connection between the PortfolioCategory type and the Taxonomy type
   */
  taxonomy?: Maybe<PortfolioCategoryToTaxonomyConnectionEdge>;
  /**
   * The name of the taxonomy that the object is associated with
   */
  taxonomyName?: Maybe<ScalarsEnums["String"]>;
 ...
 * Connection between the PortfolioCategory type and the ContentNode type
 */
export interface PortfolioCategoryToContentNodeConnection {
  __typename?: "PortfolioCategoryToContentNodeConnection";
  /**
   * Edges for the PortfolioCategoryToContentNodeConnection connection
   */
  edges?: Maybe<Array<Maybe<PortfolioCategoryToContentNodeConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
  nodes?: Maybe<Array<Maybe<ContentNode>>>;
 ...
 * An edge in a connection
 */
export interface PortfolioCategoryToContentNodeConnectionEdge {
  __typename?: "PortfolioCategoryToContentNodeConnectionEdge";
  /**
   * A cursor for use in pagination
   */
  cursor?: Maybe<ScalarsEnums["String"]>;
 ...
 * Connection between the PortfolioCategory type and the Portfolio type
 */
export interface PortfolioCategoryToPortfolioConnection {
  __typename?: "PortfolioCategoryToPortfolioConnection";
  /**
   * Edges for the PortfolioCategoryToPortfolioConnection connection
   */
  edges?: Maybe<Array<Maybe<PortfolioCategoryToPortfolioConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
 ...
 * An edge in a connection
 */
export interface PortfolioCategoryToPortfolioConnectionEdge {
  __typename?: "PortfolioCategoryToPortfolioConnectionEdge";
  /**
   * A cursor for use in pagination
   */
  cursor?: Maybe<ScalarsEnums["String"]>;
 ...
 * Connection between the PortfolioCategory type and the Taxonomy type
 */
export interface PortfolioCategoryToTaxonomyConnectionEdge {
  __typename?: "PortfolioCategoryToTaxonomyConnectionEdge";
  /**
   * The node of the connection, without the edges
   */
  node?: Maybe<Taxonomy>;
 ...
 * Connection between the Portfolio type and the PortfolioCategory type
 */
export interface PortfolioToPortfolioCategoryConnection {
  __typename?: "PortfolioToPortfolioCategoryConnection";
  /**
   * Edges for the PortfolioToPortfolioCategoryConnection connection
   */
  edges?: Maybe<Array<Maybe<PortfolioToPortfolioCategoryConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
  nodes?: Maybe<Array<Maybe<PortfolioCategory>>>;
  /**
   * Information about pagination in a connection.
   */
  pageInfo?: Maybe<WPPageInfo>;
 ...
 * An edge in a connection
 */
export interface PortfolioToPortfolioCategoryConnectionEdge {
  __typename?: "PortfolioToPortfolioCategoryConnectionEdge";
  /**
   * A cursor for use in pagination
   */
  cursor?: Maybe<ScalarsEnums["String"]>;
 ...
 * Connection between the Portfolio type and the TermNode type
 */
export interface PortfolioToTermNodeConnection {
  __typename?: "PortfolioToTermNodeConnection";
  /**
   * Edges for the PortfolioToTermNodeConnection connection
   */
  edges?: Maybe<Array<Maybe<PortfolioToTermNodeConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
 ...
 * An edge in a connection
 */
export interface PortfolioToTermNodeConnectionEdge {
  __typename?: "PortfolioToTermNodeConnectionEdge";
  /**
   * A cursor for use in pagination
   */
  cursor?: Maybe<ScalarsEnums["String"]>;
...
/**
 * Connection between the RootQuery type and the PortfolioCategory type
 */
export interface RootQueryToPortfolioCategoryConnection {
  __typename?: "RootQueryToPortfolioCategoryConnection";
  /**
   * Edges for the RootQueryToPortfolioCategoryConnection connection
   */
  edges?: Maybe<Array<Maybe<RootQueryToPortfolioCategoryConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
  nodes?: Maybe<Array<Maybe<PortfolioCategory>>>;
 ...
 * An edge in a connection
 */
export interface RootQueryToPortfolioCategoryConnectionEdge {
  __typename?: "RootQueryToPortfolioCategoryConnectionEdge";
  /**
   * A cursor for use in pagination
   */
  cursor?: Maybe<ScalarsEnums["String"]>;
...
export interface TermNode {
  __typename?: "Category" | "PortfolioCategory" | "PostFormat" | "Tag";
  /**
   * @deprecated Deprecated in favor of using Next.js pages
   */
  conditionalTags?: Maybe<ConditionalTags>;
...
export interface ThemeGeneralSettings {
  ...
  /**
   * Added to the GraphQL Schema because the ACF Field Group &quot;General Theme Settings&quot; was set to Show in GraphQL.
   */
  generalThemeSettings?: Maybe<ThemeGeneralSettings_Generalthemesettings>;
...
export interface ThemeGeneralSettings_Generalthemesettings {
  ...
  socialMediaList?: Maybe<
    Array<Maybe<ThemeGeneralSettings_Generalthemesettings_socialMediaList>>
  >;
}
 ...
 * Field Group
 */
export interface ThemeGeneralSettings_Generalthemesettings_socialMediaList {
  __typename?: "ThemeGeneralSettings_Generalthemesettings_socialMediaList";
  /**
   * The name of the ACF Field Group
   */
  fieldGroupName?: Maybe<ScalarsEnums["String"]>;
  socialIcon?: Maybe<ScalarsEnums["String"]>;
  socialLink?: Maybe<ScalarsEnums["String"]>;
  socialName?: Maybe<ScalarsEnums["String"]>;
}
...
/**
 * The payload for the UpdatePortfolioCategory mutation
 */
export interface UpdatePortfolioCategoryPayload {
  __typename?: "UpdatePortfolioCategoryPayload";
  /**
   * If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions.
   */
  clientMutationId?: Maybe<ScalarsEnums["String"]>;
...
export interface Mutation {
  ...
  createPortfolioCategory: (args: {
    input: CreatePortfolioCategoryInput;
  }) => Maybe<CreatePortfolioCategoryPayload>;
  ...
  deletePortfolioCategory: (args: {
    input: DeletePortfolioCategoryInput;
  }) => Maybe<DeletePortfolioCategoryPayload>;
  ...
  updatePortfolioCategory: (args: {
    input: UpdatePortfolioCategoryInput;
  }) => Maybe<UpdatePortfolioCategoryPayload>;
...
export interface Query {
  ...
  portfolioCategories: (args?: {
    ...
    first?: Maybe<Scalars["Int"]>;
    last?: Maybe<Scalars["Int"]>;
    where?: Maybe<RootQueryToPortfolioCategoryConnectionWhereArgs>;
  }) => Maybe<RootQueryToPortfolioCategoryConnection>;
  portfolioCategory: (args: {
    id: Scalars["ID"];
    idType?: Maybe<PortfolioCategoryIdType>;
  }) => Maybe<PortfolioCategory>;
  post: (args: {
    asPreview?: Maybe<Scalars["Boolean"]>;
    id: Scalars["ID"];
...
export interface SchemaObjectTypes {
  ...
  CreatePortfolioCategoryPayload: CreatePortfolioCategoryPayload;
  ...
  DeletePortfolioCategoryPayload: DeletePortfolioCategoryPayload;
  ...
  Page_Fieldlayoutoptions: Page_Fieldlayoutoptions;
  Page_Fieldlayoutoptions_FlexibleLayouts_AboutInfo: Page_Fieldlayoutoptions_FlexibleLayouts_AboutInfo;
  Page_Fieldlayoutoptions_FlexibleLayouts_CareersSection: Page_Fieldlayoutoptions_FlexibleLayouts_CareersSection;
  Page_Fieldlayoutoptions_FlexibleLayouts_CareersSection_positionsList: Page_Fieldlayoutoptions_FlexibleLayouts_CareersSection_positionsList;
  ...
  Page_Fieldlayoutoptions_FlexibleLayouts_FullWidthCta_buttons: Page_Fieldlayoutoptions_FlexibleLayouts_FullWidthCta_buttons;
  Page_Fieldlayoutoptions_FlexibleLayouts_HeroSection: Page_Fieldlayoutoptions_FlexibleLayouts_HeroSection;
  Page_Fieldlayoutoptions_FlexibleLayouts_HeroSection_buttons: Page_Fieldlayoutoptions_FlexibleLayouts_HeroSection_buttons;
  Page_Fieldlayoutoptions_FlexibleLayouts_InnerBannerSection: Page_Fieldlayoutoptions_FlexibleLayouts_InnerBannerSection;
  Page_Fieldlayoutoptions_FlexibleLayouts_InnerBannerSection_buttons: Page_Fieldlayoutoptions_FlexibleLayouts_InnerBannerSection_buttons;
  Page_Fieldlayoutoptions_FlexibleLayouts_IntroSection: Page_Fieldlayoutoptions_FlexibleLayouts_IntroSection;
  Page_Fieldlayoutoptions_FlexibleLayouts_IntroSection_introPoints: Page_Fieldlayoutoptions_FlexibleLayouts_IntroSection_introPoints;
  ...
  PortfolioToTermNodeConnection: PortfolioToTermNodeConnection;
  ...
  RootQueryToPortfolioCategoryConnection: RootQueryToPortfolioCategoryConnection;
  RootQueryToPortfolioCategoryConnectionEdge: RootQueryToPortfolioCategoryConnectionEdge;
  ...
  UpdatePortfolioCategoryPayload: UpdatePortfolioCategoryPayload;
...
export interface ScalarsEnums extends MakeNullable<Scalars> {
  ...
  ContentTypesOfPortfolioCategoryEnum:
    | ContentTypesOfPortfolioCategoryEnum
    | undefined;
